...
public:
  ...
  double GBM_step(double start_value, double mean, double sigma, double T, int N);     //esegue GBM(mean, sigma) per un tempo T, dividendo l'intervallo (0,T) in N sottointervalli
};
